...
if sq==1:
    ...
    if sq1==1:
        ...
        for r in empdata:
            print(r)
        p.close()
        print("PLEASE OPEN STUDENT.csv To See Your Entries")
    if sq1==2:
...
if sq==2:
    ...
    if sq1==1:
        ...
        for r in empdata:
            print(r)
        p.close()
        print("PLEASE OPEN COURSE.csv To See Your Entries")
    if sq1 == 2:
        def modification(mst):
            i = 0
            j = 0
...
if sq==3:
    ...
    if sq1==1:
        ...
        for r in empdata:
            print(r)
        p.close()
        print("PLEASE OPEN BATCH.csv To See Your Entries")
    if sq1 == 2:
        def modification(mst):
            i = 0
            j = 0
    ...
    if sq1 == 4:
        ...
        while t < u:
            ...
            t = t + 2
        g.close()
        print("PLEASE OPEN FULL REPORT.txt FROM FILE SECTION")
    if sq1 == 5:
        def modification(mst):
            i = 0
            j = 0
        ...
        plt.show()
if sq==4:
    print("Enter 1 For Entry in Department Module")
    print("Enter 2 To View list of all students in a batch")
    ...
    if sq1 == 1:
        ...
        for r in empdata:
            print(r)
        p.close()
        print("PLEASE OPEN DEPARTMENT.csv To See Your Entries")
    if sq1==2:
        def modification(mst):
            i = 0
            j = 0
...
if sq==5:
    ...
    if sq1==1:
        ...
        for r in empdata:
            print(r)
        p.close()
        print("PLEASE OPEN EXAMINATION_PERFORMANCE.csv To See Your Entries")
    if sq1 == 2:
        import csv
        p = open("EXAMINATION_PERFORMANCE.csv", "r", newline="")
        empdata = csv.reader(p)
